...
DATASET_ROOT=${DATASET_ROOT:-${TEXT2IMAGE_DIR}/Activations/i2p_no_sexual_flux_real}
HOOK_NAME=${HOOK_NAME:-transformer.double_transformer_blocks.18}
RUN_NAME=${RUN_NAME:-flux_real_doubleblock18_i2p_no_sexual}
...
{
  echo "=== SAE Training (Flux real double block 18) ==="
