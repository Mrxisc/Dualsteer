...
HOOK_NAME=${HOOK_NAME:-transformer.double_transformer_blocks.18}
BASE_SAE_DIR=${BASE_SAE_DIR:-${TEXT2IMAGE_DIR}/SAEs/flux_real_doubleblock18_i2p_no_sexual_i2p_no_sexual_flux_real}
...
OUTPUT_SAE_DIR=${OUTPUT_SAE_DIR:-${TEXT2IMAGE_DIR}/SAEs/flux_real_doubleblock18_sexual_transfer}
LOG_DIR=${LOG_DIR:-${TEXT2IMAGE_DIR}/Logs}
mkdir -p "${LOG_DIR}"
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_FILE="${LOG_DIR}/transfer_flux_doubleblock_real_${TIMESTAMP}.log"
...
{
	echo "=== Flux REAL DoubleBlock SAE Transfer ==="
