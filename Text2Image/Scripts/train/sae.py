    ...
    def load_from_disk(
        ...
        *,
        ...
        if weight_dtype is None:
            ...
            with safe_open(path / "sae.safetensors", framework="pt") as f:
                if "encoder.weight" in f.keys():
                    weight_dtype = f.get_tensor("encoder.weight").dtype


        sae = Sae(d_in, cfg, device=device, dtype=weight_dtype, decoder=decoder)
        load_model(
            model=sae,
